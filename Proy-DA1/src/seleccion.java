...
public class seleccion {
	...
	public static void main(String[] args){
		...
		System.out.println("k-esimo(5º): " + select(v,5));
		...
		System.out.println("k-esimo(5º): " + select(v2,5));
		...
		System.out.println("k-esimo(5º): " + select(v3,5));
		...
		System.out.println("k-esimo(8º): " + select(v4,8));
